...
/// <summary>
/// 自动更新：从更新服务器（107 服务器静态文件服务）检测最新版本、下载 exe，
/// 并通过批处理脚本替换重启。
/// </summary>
public static class Updater
{
    /// <summary>更新服务器地址（107 服务器 nginx 静态服务）。</summary>
    public const string UpdateBaseUrl = "http://107.175.228.83:8080";
    ...
    public static async Task<string?> DownloadAsync(string dataDir)
    {
        ...
        try
        {
            ...
            var bytes = await http.GetByteArrayAsync($"{UpdateBaseUrl}/ClipboardTool.exe");
